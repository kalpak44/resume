...
export const projects = [
  {
    ...
    technologies: ['Java', 'Spark Java', 'WebSockets', 'JavaScript', 'Tailwind CSS', 'SonarCloud', 'JaCoCo', 'Jib', 'Docker', 'Maven'],
  ...
  },
  {
    ...
    technologies: ['Kubernetes', 'MicroK8s', 'FluxCD', 'GitOps', 'Traefik', 'MetalLB', 'Cloudflare', "Let's Encrypt", 'NFS', 'Trivy Operator', 'Grafana', 'Prometheus', 'AdGuard Home', 'PostgreSQL', 'NGINX', 'Helm'],
  ...
  },
  {
    ...
    technologies: ['Java 17', 'TelegramBots API', 'Stripe Java SDK', 'Docker', 'ARM32', 'Maven', 'SLF4J', 'Logback'],
  ...
  },
  {
    ...
    summary: 'A tiny VS Code extension that randomly opens files and wiggles the cursor - because apparently being "active" is a KPI now 😄',
    technologies: ['JavaScript', 'Node.js', 'VS Code Extension API', 'GitHub Actions', 'CI/CD'],
  ...
  },
  {
    ...
    technologies: ['Docker', 'Kubernetes', 'PostgreSQL', 'AWS CLI', 'S3', 'kubectl', 'Alpine Linux', 'Shell Scripting', 'GitHub Actions', 'GHCR'],
    details: k8sUtilMd,
  },
]